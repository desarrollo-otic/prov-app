            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="pages/ingresar/ing-med.php">Artículos de Farmacia</a>
                            </li>
                            <li>
                                <a href="pages/ingresar/ing-bienes.php">Bienes Nacionales</a>
                            </li>
                            <li>
                                <a href="pages/ingresar/ing-otros.php">Otros</a>
                            </li>
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="pages/despacho/desp-med.php">Artículos de Farmacia</a>
                            </li>
                            <li>
                                <a href="pages/despacho/desp-bienes.php">Bienes Nacionales</a>
                            </li>
                            <li>
                                <a href="pages/despacho/desp-otros.php">Otros</a>
                            </li>
            ...
            <div class="row clearfix">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-green hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text">INVENTARIO TOTAL</div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-cyan hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text">TOTAL ENTREGADO</div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-red hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text">INVENT. MÍNIMO</div>
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-xs-12 col-sm-6 align-right">
                                    <div class="switch panel-switch-btn">
                                        ...
                                        <label>DESACTIVAR<input type="checkbox" id="realtime" checked><span class="lever switch-col-cyan"></span>ACTIVAR</label>
                                    </div>
                                </div>
                            </div>
