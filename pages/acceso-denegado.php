...
<head>
    ...
    <title>Proveeduría del Estado Zulia | Acceso Denegado</title>
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="block-header ">
                    <center>
                    <br><br><br><br><br><br>
                    <i class="material-icons" style="font-size:200px;color:red">warning</i>
                    <br><br>
                ...
                <div class="container-fluid">
                   <div class="col-xs-6 col-sm-4 col-md-5 col-lg-2 col-lg-push-5 col-md-4 col-sm-push-4 col-xs-push-3">
                       <a href="../dashboard.php"><button type="button" class="btn bg-teal btn-block btn-lg waves-effect">ATRÁS</button></a>
                   </div>
                </div>   
            </div>
        </section>
