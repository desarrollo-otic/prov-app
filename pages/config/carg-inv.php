...
<head>
    ...
    <title>Proveeduría del Estado Zulia | Cargar Inventario Inicial</title>
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">Cargar Inventario Inicial</a>
            </div>
             ...
             <div class="menu">
                <ul class="list">
                    ...
                    <li class="active">
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="agr-usu.php">Agregar Usuarios</a>
                            </li>
                            <li>
                                <a href="cam-cont.php">Cambiar Contraseña</a>
                            </li>
                            <li class="active">
                                <a href="carg-inv.php">Cargar Inventario Inicial</a>
                            </li>
                        </ul>
                    </li>
                    <li>
