...
<head>
    ...
    <title>Proveeduría del Estado Zulia | Ingresar Artículos de Farmacia</title>
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">Ingresar Artículos de Farmacia</a>
            </div>
                ...
                <ul class="list">
                    ...
                    <li class="active">
                        ...
                        <ul class="ml-menu">
                            ...
                            <!--<li>
                                <a href="../ingresar/ing-mmq.html">Material Médico-Quirúrgico</a>
                            </li>-->
                            <li>
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="../despacho/desp-med.php">Artículos de Farmacia</a>
                            </li>
                            <li>
                                <a href="../despacho/desp-bienes.php">Bienes Nacionales</a>
                            </li>
                            <li>
                                <a href="../despacho/desp-otros.php">Otros</a>
                            </li>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header container-fluid">
                          <button type="button" class="btn bg-teal waves-effect pull-right col-sm-2 col-xs-12" data-toggle="modal" data-target="#defaultModal">AGREGAR NUEVO</button>
                        </div>
                        <div class="body">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">Agregar Medicamento</h4>
                 </div>
