...
<head>
    ...
    <title>Proveeduría del Estado Zulia | Ingresar Material Médico-Quirúrgico</title>
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Ingresar Material Médico-Quirúrgico</a>
            </div>
            ...
            <div class="menu">
                    <ul class="list">
                        ...
                        <li class="active">
                            ...
                            <ul class="ml-menu">
                                <li>
                                    <a href="../ingresar/ing-med.php">Medicamentos</a>
                                </li>
                                <li class="active">
                                    <a href="../ingresar/ing-mmq.php">Material Médico-Quirúrgico</a>
                                </li>
                                <li>
                                    <a href="../ingresar/ing-bienes.php">Bienes</a>
                                </li>
                                <li>
                        ...
                        <li>
                            ...
                            <ul class="ml-menu">
                                <li>
                                    <a href="../despacho/desp-med.php">Medicamentos</a>
                                </li>
                                <li>
                                    <a href="../despacho/desp-mmq.php">Material Médico-Quirúrgico</a>
                                </li>
                                <li>
                                    <a href="../despacho/desp-bienes.php">Bienes</a>
                                </li>
                                <li>
